                ...
                <div className="flex flex-col h-full">
                  ...
                  <div className="mb-4">
                    {category.icon.includes("images") ? (
                      <div
                        className={`w-16 h-16 rounded-xl bg-gradient-to-br  flex items-center justify-center text-3xl shadow-lg`}
                      >
                        <Image width={64} height={64} alt="image" className="object-contain" src={category.icon} />
                      </div>
                    ) : (
                      <div
